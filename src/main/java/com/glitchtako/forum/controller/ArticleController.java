...
public class ArticleController extends BaseController {
    ...
    public RestResponse<Article> getArticleById(@PathVariable Long id) throws ArticleNotFoundException {
    ...
    public RestResponse<PagedDTO<ArticleComment>> pageComments(@PathVariable Long id, PageArticleCommentRequest request) {
